...
<?php if ( ! $is_ajax ) : ?><div id="order_review"><?php endif; ?>
	<table class="shop_table">
		<thead>
			<tr>
				<th class="product-name"><?php _e( 'DETAILS', 'woocommerce' ); ?></th>
			</tr>
		</thead>
			<tbody>
			<?php
	...
	<div id="payment">
		...
		<div class="form-row place-order">
			...
			echo apply_filters( 'woocommerce_order_button_html', '<input type="submit" class="button alt view2" name="woocommerce_checkout_place_order" id="place_order" value="Send Enquiry" data-value="' . esc_attr( $order_button_text ) . '" />' );
			?>
