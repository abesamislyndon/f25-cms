...
<table class="shop_table cart" cellspacing="0">
	<thead>
		<tr>
			...
			<th class="product-thumbnail">&nbsp;THUMBNAIL PHOTO</th>
			<th class="product-name"><?php _e( 'PROJECT', 'woocommerce' ); ?></th>
			...
			<td colspan="6" class="actions">
				...
				<div class="col-sm-3">
					<div class="cart-button">
						<input type="submit" class="add_to_cart_button" name="update_cart" value="<?php _e( 'Update Enquiry', 'woocommerce' ); ?>" /> 
						<input type="submit" class="checkout-btn view1" name="proceed" value="<?php _e( 'Proceed to Submit &rarr;', 'woocommerce' ); ?>" />			
					</div>
				</div>
